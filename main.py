...
if __name__ == "__main__":
    ...
    parser.add_argument('-rm', '--rank_mode', type=str, default='本月', help="['今日','本周','本月','新人',"
                                                                           ...
                                                                           "才有(受男/女性欢迎模式)")
    parser.add_argument('-rc', '--rank_content', type=str, default='illustration', help="['all','illustration','gif']")
    parser.add_argument('-d', '--datetime', type=bool, default=True, help="the end day")
